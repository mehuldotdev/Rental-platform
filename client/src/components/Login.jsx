...
const Login = ({setShowLogin}) => {
  ...
  return (
    <div onClick={()=> setShowLogin(false)} className='fixed inset-0 flex items-center justify-center bg-black/60 bg-opacity-50 z-50'>
        <form onSubmit={onSubmitHandler} onClick={(e)=>e.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white">
            ...
            <p className="text-2xl font-medium m-auto">
                ...
                <span className="text-blue-700">User</span> {state === "login" ? "Login" : "Sign Up"}
            ...
            <button className="bg-blue-700 hover:bg-indigo-600 transition-all text-white w-full py-2 rounded-md cursor-pointer">
